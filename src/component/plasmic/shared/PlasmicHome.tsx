          ...
          <div className={classNames(defaultcss.all, sty.box___70Att)}>
            ...
            >
              ...
              >
                ...
                <Update
                  className={classNames("__wab_instance", sty.update__bJcWl)}
                />
...
const PlasmicDescendants = {
  root: ["root", "header", "sidebar", "main2", "container", "mainHeader"],
  header: ["header"],
  sidebar: ["sidebar"],
  main2: ["main2", "container", "mainHeader"],
  container: ["container", "mainHeader"],
