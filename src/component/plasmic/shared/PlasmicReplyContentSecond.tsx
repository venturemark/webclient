  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(defaultcss.all, sty.box__yr59G)} />
          ...
          <div className={classNames(defaultcss.all, sty.box__y7Gdr)}>
            ...
            >
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box___1Bypj, {
              ...
              >
                <div className={classNames(defaultcss.all, sty.box___5LY0W)}>
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.box__hb8Xt)}
                  >
                    <p.PlasmicSlot
                      defaultContents={
                        <span
                ...
                {(hasVariant(variants, "state", "isUser") ? true : false) ? (
                  <div
                    className={classNames(defaultcss.all, sty.box__tIZzq, {
                  ...
                  >
                    <div
                      className={classNames(defaultcss.all, sty.box__uYdyB, {
              ...
              <div className={classNames(defaultcss.all, sty.box___3DEhu)}>
                <div className={classNames(defaultcss.all, sty.box__qZfSk)}>
                  <p.PlasmicSlot
                    defaultContents={
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicReplyContentSecond__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
