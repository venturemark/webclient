...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: tOAAQS_ohI6/component
import Select__Option from "../../Select__Option"; // plasmic-import: mb6SKWRg0eo/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_shared.module.css"; // plasmic-import: mTVXT6w3HHjZ4d74q3gB76/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: ueoKgZ85w4z/css
      ...
      >
        ...
        >
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconAccordianIcon
                className={classNames(projectcss.all, sty.svg__qphIg)}
                role={"img"}
              />
            ),
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__btEy7)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option___33Kqa)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
...
const PlasmicDescendants = {
  root: ["root", "trigger", "contentContainer", "overlay", "optionsContainer"],
  trigger: ["trigger", "contentContainer"],
