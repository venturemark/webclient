...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: _qh5Wzylsri/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: ueoKgZ85w4z/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__sMbbS)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__hm5TK)}
              />
            </React.Fragment>
          ),
          value: args.children,
