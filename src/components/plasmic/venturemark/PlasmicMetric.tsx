...
import "./PlasmicMetric.css"; // plasmic-import: yAnxCRnRr7/css
  ...
  return (
    <div
      ...
      className={classNames({
        Metric__metricItem__SjbYg: true,
    ...
    >
      ...
      >
        <PlasmicSlot
          ...
          value={args.name}
          className={classNames({ Metric__slotName__XUOfE: true })}
        />
      </div>

      <div
        className={classNames({
          Metric__box__ESmQi: true,
          "plasmic-default__all": true,
          "plasmic-default__div": true
        })}
      >
        <img
          ...
          alt={""}
          className={classNames({
            Metric__graphContainer__2Zlen: true,
            "plasmic-default__all": true,
