...
export class SearchO_Obj_Property extends jspb.Message {
  ...
  setDataList(value: Array<SearchO_Obj_Property_Data>): SearchO_Obj_Property;
  clearDataList(): SearchO_Obj_Property;
  addData(
    value?: SearchO_Obj_Property_Data,
    index?: number
...
export class SearchO_Obj_Property_Data extends jspb.Message {
  getSpace(): string;
  setSpace(value: string): SearchO_Obj_Property_Data;

  getValueList(): Array<number>;
  setValueList(value: Array<number>): SearchO_Obj_Property_Data;
  clearValueList(): SearchO_Obj_Property_Data;
  addValue(value: number, index?: number): SearchO_Obj_Property_Data;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SearchO_Obj_Property_Data.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: SearchO_Obj_Property_Data
  ): SearchO_Obj_Property_Data.AsObject;
  static serializeBinaryToWriter(
    message: SearchO_Obj_Property_Data,
    writer: jspb.BinaryWriter
  ): void;
  static deserializeBinary(bytes: Uint8Array): SearchO_Obj_Property_Data;
  static deserializeBinaryFromReader(
    message: SearchO_Obj_Property_Data,
    reader: jspb.BinaryReader
  ): SearchO_Obj_Property_Data;
