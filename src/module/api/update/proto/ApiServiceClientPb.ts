/**
 * @fileoverview gRPC-Web generated client stub for update
 * @enhanceable
 * @public
 */
...
export class APIClient {
  ...
  create(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/update.API/Create",
        request,
        metadata || {},
  ...
  delete(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/update.API/Delete",
        request,
        metadata || {},
  ...
  search(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/update.API/Search",
        request,
        metadata || {},
  ...
  update(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/update.API/Update",
        request,
        metadata || {},
