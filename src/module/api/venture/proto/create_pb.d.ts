...
export class CreateI_Obj_Property extends jspb.Message {
  ...
  getLinkList(): Array<CreateI_Obj_Property_Link>;
  setLinkList(value: Array<CreateI_Obj_Property_Link>): CreateI_Obj_Property;
  clearLinkList(): CreateI_Obj_Property;
  addLink(
...
export namespace CreateI_Obj_Property {
  export type AsObject = {
    desc: string;
    linkList: Array<CreateI_Obj_Property_Link.AsObject>;
    name: string;
  };
}
...
export class CreateI_Obj_Property_Link extends jspb.Message {
  ...
  getText(): string;
  setText(value: string): CreateI_Obj_Property_Link;
