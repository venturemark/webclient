...
export class SearchO_Obj_Property extends jspb.Message {
  ...
  getLinkList(): Array<SearchO_Obj_Property_Link>;
  setLinkList(value: Array<SearchO_Obj_Property_Link>): SearchO_Obj_Property;
  clearLinkList(): SearchO_Obj_Property;
  addLink(
...
export namespace SearchO_Obj_Property {
  export type AsObject = {
    desc: string;
    linkList: Array<SearchO_Obj_Property_Link.AsObject>;
    name: string;
  };
}
...
export class SearchO_Obj_Property_Link extends jspb.Message {
  ...
  getText(): string;
  setText(value: string): SearchO_Obj_Property_Link;
